...
TextMessage::TextMessage(const std::string& content, const sf::Vector2f& position, unsigned int size,
	const MessageType& type, bool alive)
	: m_content{ content }, m_position{ position }, m_size{ size }, m_messageType{type}, m_scale{ 1.f }, m_alive{alive}
{
